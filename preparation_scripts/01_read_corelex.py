...
corelex_folder = os.path.join('..', 'other_ratings', 'corelex')
...
pyplot.savefig(os.path.join('distributions_plots', 'polysemes_frequencies.jpg'))

### writing to file the candidates
candidates_path = os.path.join('results', 'corelex_candidate_nouns.txt')
